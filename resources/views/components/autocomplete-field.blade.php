...
<div x-data="autocompleteField({{ Js::from($items) }})" @click.outside="filtered = []" class="position-relative w-100" style="min-height: 3rem;">
    <input type="text" class="form-control" x-model="query" @input="filter"
