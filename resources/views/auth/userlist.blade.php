                                                                    ...
                                                                    <div class="form-floating mb-3">
                                                                        <select name="role" id="floatingSelect"
                                                                            ...
                                                                            <option value="super-admin"
                                                                                ...
                                                                                super-admin</option>
                                                                            <option value="holding-admin"
                                                                                @selected($user->role == 'holding-admin')>
                                                                                holding-admin</option>
                                                                            <option value="eln-admin"
                                                                                @selected($user->role == 'eln-admin')>
                                                                                eln-admin
                                                                            </option>
                                                                            <option value="eln2-admin"
                                                                                @selected($user->role == 'eln2-admin')>
                                                                                eln2-admin</option>
                                                                            <option value="haka-admin"
                                                                                @selected($user->role == 'haka-admin')>haka-admin
                                                                            </option>
                                                                            <option value="bofi-admin"
                                                                                @selected($user->role == 'bofi-admin')>bofi-admin
                                                                            </option>
                                                                            <option value="rmm-admin"
                                                                                @selected($user->role == 'rmm-admin')>rmm-admin
                                                                            </option>
                                                                        </select>
                                                                        <label for="floatingSelect">level</label>
                                                                        @error('role')
