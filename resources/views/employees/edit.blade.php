                ...
                <form action="{{ route('employees.update', ['employee' => $employee->id]) }}" method="post"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <select class="form-select" name="subsidiary_id" id="perusahaan"
                                value="{{ $employee->subsidiary_id }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <select class="form-select" name="status_peg" id="status_peg"
                                value="{{ $employee->status_peg }}">
