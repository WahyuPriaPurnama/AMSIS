            ...
            placeholder="Cari Nama atau NIP" @endif
                ...
                <div class="col text-end">
                    @can('create', App\Models\Employee::class)
                        <a href="{{ route('employees.excel') }}" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-spreadsheet-fill" viewBox="0 0 16 16">
                    ...
                    <a href="{{ route('employees.pdf') }}" class="btn btn-danger" target="_blank" data-bs-toggle="tooltip"
                        data-bs-title="export PDF"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
