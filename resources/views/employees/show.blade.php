    ...
    <div class="container mt-3">
        <div class="d-flex justify-content-between">
            <div class="d-flex">
                ...
                @endcan
                @can('delete', $employee)
                <button type="submit" form="delete" class="btn btn-danger ms-3">Hapus</button>
                <form id="delete" action="{{ route('employees.destroy', ['employee' => $employee->id]) }}" method="post">
                    @method('DELETE')
                    @csrf
                </form>
                @endcan
            </div>
            <a href="{{ route('employee.pdf',['employee' => $employee->id]) }}" class="btn btn-danger" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf-fill" viewBox="0 0 16 16">
